...
import { TypographySystem,Typography, Accordion, AccordionDetails, AccordionSummary } from '@mui/joy';
...
function PlanForm({
    ...
    if (key === 'area') {
      ...
      return <TableForModules rows = {rows} nestedKeys = {nestedKeys}></TableForModules>
    } else {
