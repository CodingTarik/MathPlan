...
if (process.argv.length < 4) {
  console.log('Usage: node moduleDescriptionParserCLI.js <filename> <configuration>');
  console.log('  filename:      The path to the pdf file containing the module descriptions.');
  console.log('  configuration: The path to the configuration file to be used for parsing the module descriptions.');
  process.exit(1);
}
...
readAndFilterData(dataBuffer, configurationFilePath).then((modules) => {
